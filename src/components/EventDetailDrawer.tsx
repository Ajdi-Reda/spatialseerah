    ...
    >
      ...
      <div className="flex justify-between items-center mb-4 pb-3 border-b border-ink-900/10">
        ...
        <button 
          ...
          className="w-8 h-8 flex items-center justify-center rounded-full bg-ink-900/5 hover:bg-ink-900/10 text-ink-900 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink-900 cursor-pointer"
        >
          ✕
        </button>
      </div>
      
      <h2 className={`font-serif font-bold text-ink-900 text-xl sm:text-2xl leading-tight mb-4 ${isRTL ? 'font-arabic text-2xl sm:text-3xl' : ''}`}>
        {title}
      </h2>
